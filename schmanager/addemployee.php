	...
	$(document).ready(function(e){
		...
		dataType:'json',
		  success: function(returndata)
		  {
			  ...
			  if(staffno<=9){ staffno=staffno + 1; staffno='000'+staffno;}
			  else if(staffno>=10){staffno=staffno + 1; staffno='00'+staffno;}
			  else if(staffno>=100){staffno=staffno + 1; staffno='0'+staffno;}
			  else if(staffno>=1000){staffno=staffno + 1; staffno=staffno;}
			  else if(isNaN(staffno)==true){staffno='000'+1;}
			  //alert(staffno);
			  $('#stafnum').val(staffno);
			  },
