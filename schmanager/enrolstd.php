	 ...
	 $(document).ready(function(e){
		...
		dataType:'json',
		  success: function(returndata)
		  {
			  ...
			  if(stdno<=9){stdno=stdno + 1; stdno='000'+stdno;}
			  else if(stdno>=10){stdno=stdno + 1; stdno='00'+stdno;}
			  else if(stdno>=100){stdno=stdno + 1; stdno='0'+stdno;}
			  else if(stdno>=1000){stdno=stdno + 1; stdno=stdno;}
			  else if(isNaN(stdno)==true){stdno='000'+1;}
			  $('#rollnum').val(stdno);
			  },
